    ...
    <table id="tablaAutomatica" style="text-align: center; width: 70%;">
        ...
        <tbody>
            ...
            <tr id="{{ $item->id }}">
                ...
                <td dt-type="text" dt-col="category" dt-col_ca="Nom">{{ $item->category }}</td>
                ...
                <td>
                    <button dt-tb="category" dt-id="{{ $item->id }}" class="btn btn-danger deletebtn"><i class="fas fa-trash"></i></button>
